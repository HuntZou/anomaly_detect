...
class ADMvTec(TorchvisionDataset):
    ...
    def __init__(self, root: str, normal_class: int, preproc: str, nominal_label: int,
        ...
        :param online_supervision: whether to sample anomalies online in each epoch,是否在每个epoch对样本异常进行采样
        ...
        if preproc == 'lcn':
            ...
            # img_gt_transform = transforms.Compose([
