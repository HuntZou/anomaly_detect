...
from modules.modules import BasicBlock, Bottleneck
...
class HRNet(nn.Module):
    def __init__(self, c=48, nof_joints=17, bn_momentum=0.1, in_channels=3):
        super(HRNet, self).__init__()

        # Input (stem net)
        self.conv1 = nn.Conv2d(in_channels, 64, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
        ...
        # pretrain model: https://drive.google.com/drive/folders/1nzM_OBV9LbAEA7HClC0chEyf_7ECDXYA
        self.load_state_dict(torch.load(r'D:\Downloads\pose_hrnet_w48_384x288.pth'))
